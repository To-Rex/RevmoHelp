      ...
      const processedDiseases = data?.map(disease => {
        ...
        if (translation) {
          return {
            ...
            full_description: translation.full_description || disease.full_description,
    ...
    try {
      ...
      if (translationError || !translationData) {
        ...
        if (!baseTranslationError && baseTranslationData) {
          ...
          if (!correctTranslationError && correctTranslationData) {
            ...
            const processedDisease = {
              ...
              full_description: correctTranslationData.full_description || disease.full_description,
        ...
        const processedDisease = translation ? {
          ...
          name: translation.name,
          description: translation.description,
          full_description: translation.full_description || data.full_description,
      ...
      const processedDisease = {
        ...
        full_description: translationData.full_description || disease.full_description,
